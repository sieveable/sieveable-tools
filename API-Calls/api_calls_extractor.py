...
log = logging.getLogger("api_calls_extractor")
log.setLevel(
...
class APICallsExtractor(object):
    def __init__(self):
    ...
    def main(self, args):
        ...
        parser = OptionParser(
            ...
            description='This tool recursively searches for '
                        'invoke- methods calls from smali files '
                        'and store them in one text file.')
...
if __name__ == '__main__':
    APICallsExtractor().main(sys.argv[1:])
